...
const Modal = ({
  ...
  const style = {
    ...
    btn: "bg-purple-600 hover:bg-purple-800 items-end text-white font-bold py-2 px-4 rounded-lg w-[100px] mt-[24px] disabled:bg-gray-500 disabled:cursor-not-allowed",
  };
  return (
